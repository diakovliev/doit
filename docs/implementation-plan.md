...
| `TOOL-008` | Implement reviewable change sets and transactional edits. | `TOOL-004`, `TOOL-006`, `TOOL-007`, `HARD-003`, `HARD-004` | Writes produce a previewable change set with before/after hashes, approval identity, conflict detection, and atomic-or-rollback behavior across multi-file operations. | `IN PROGRESS` |
